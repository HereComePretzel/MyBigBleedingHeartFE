...
class Profile extends React.Component{
  ...
  // handleDelete = (e) => {
  //   fetch(`http://localhost:3000/users/${this.props.users.id}`, {method: 'DELETE'})
  //   .then(resp => resp.json())
  //   .then(user => {
  ...
  {/* <Button className='deleteprofilebutton' onClick={this.handleDelete} type='submit'>Delete</Button> */}
</Form>
            </div>
        )
    }
